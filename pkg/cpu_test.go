...
func TestIndirectIndexedAddressingSequence(t *testing.T) {
	cpu := setupCPU()
	...
	cpu.assertAEquals(t, 0x0a)
	cpu.assertXEquals(t, 0x0a)
	cpu.assertYEquals(t, 0x01)
	cpu.assertPCEquals(t, 0x0611)

	cpu.assertMemoryEquals(t, 0x00, 0x00, 0x03, 0x07)
	cpu.assertMemoryEquals(t, 0x0704, 0x0a)
}
