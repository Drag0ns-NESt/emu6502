...
func TestLoopUsingStack(t *testing.T) {
	cpu := setupCPU()
	...
	cpu.assertAEquals(t, 0x00)
	cpu.assertXEquals(t, 0x10)
	cpu.assertYEquals(t, 0x20)
	cpu.assertPCEquals(t, 0x0618)
	cpu.assertMemoryEquals(t, 0x0200,
		0x00, 0x01, 0x02, 0x03,
		0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0a, 0x0b,
		0x0c, 0x0d, 0x0e, 0x0f,
...
func TestSimpleSequenceWithJump(t *testing.T) {
	cpu := setupCPU()
	...
	cpu.assertAEquals(t, 0x03)
	cpu.assertMemoryEquals(t, 0x200, 0x03)
}

func TestSubroutinesSequence(t *testing.T) {
	cpu := setupCPU()
	...
	cpu.assertXEquals(t, 0x05)
	cpu.assertSPEquals(t, 0xfd)
	cpu.assertCarryEquals(t, true)
	cpu.assertZeroEquals(t, true)
	cpu.assertPCEquals(t, 0x0613)
}
